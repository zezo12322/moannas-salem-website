...
export const metadata: Metadata = {
  title: "أمان قلمي — حملاتنا — مؤنث سالم",
  description: "حملة لحماية الصحفيات من العنف الرقمي والمضايقات الميدانية. لأن قلم الصحفية لا يجب أن يُكلّفها أمانها.",
};

const voices = [
  {
    quote: "بعد تقرير نشرته عن قضية فساد، بدأت أتلقى رسائل تهديد على إيميلي الشخصي وحسابي على تويتر. كان واضحًا إن حد ما بيحاول يوقّفني.",
    role: "صحفية استقصائية، ٢٠٢٤",
  },
  {
    quote: "في التغطية الميدانية، زميلي الرجل بيعدي كويس. أنا بحتاج أشرح نفسي لكل حد وبعدين لما أكتب بيقولوا 'البنت اللي كتبت ده'.",
    role: "مراسلة إذاعية، ٢٠٢٣",
  },
];

export default function AmanQalamiPage() {
  return (
    <>
      <NavBar />
      <main id="main-content" className="flex-1 pb-16 md:pb-0">
        <div className="max-w-[720px] mx-auto px-4 md:px-8 py-12 md:py-16">
          ...
          <p className="text-[17px] font-semibold text-[#4B245E] leading-[1.6] mb-8 border-s-4 border-[#4B245E] ps-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-[15px] text-[#6B5D6E] leading-[1.9]">
              الصحفيات في مصر يتعرّضن لعنف رقمي ممنهج — تحرش، ابتزاز، حملات تشويه —
              بهدف إسكاتهن وإبعادهن عن المهنة. هذا يُقلّص حرية الصحافة ويُفقر المشهد
              الإعلامي. حملة "أمان قلمي" توثّق هذا الواقع وتطالب بحماية حقيقية.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-[#FAF5EF] rounded-[14px] p-5">
              <p className="text-[14px] text-[#6B5D6E] leading-[1.8]">
                كثير من الصحفيات لا يُبلّغن عن التحرش الإلكتروني لأنهن يخشين أن يُتّهمن
                بالمبالغة أو أن يفقدن مصداقيتهن المهنية. المؤسسات الإعلامية في كثير من
                الأحيان لا توفر آليات دعم أو حماية لموظفاتها في الفضاء الرقمي.
              </p>
            </div>
          </section>
          ...
          <div className="bg-[#4B245E] rounded-[20px] p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/guide/digital-safety/online-harassment" className="inline-flex items-center justify-center gap-2 border border-white text-white font-semibold text-[14px] px-5 py-2.5 rounded-full hover:bg-white/10 transition-colors">
                دليل السلامة الرقمية <span aria-hidden="true">←</span>
              </Link>
            </div>
          </div>
